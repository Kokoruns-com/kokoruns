    ...
    render() {
        return (
            <div className="container mx-auto" style={{ margin: '4rem' }}>
                <div className="row bg-white mx-auto m-0">
                    <div className="col-md-8">
                        <div className="pt-4 pl-4 pr-4">
                            <h3 className="mb-4">Create A Company Page</h3>
                                ...
                                <div className="row m-0">
                                    <div className="col">
                                        <div className="form-group p-floating-container">
                                            ...
                                            <input type="text" className="form-control rounded-0" id="company_name" name="company_name" aria-label="Company Name" maxLength={45} autoComplete="off" value={this.state.company_name} onChange={this.handleChange} required />
                                ...
                                <div className="row m-0">
                                    <div className="col-12 col-md-6">
                                        <div className="form-group p-floating-container">
                                            ...
                                            <input type="number" min={0} name="company_number" id="company_number" className="form-control rounded-0" value={this.state.company_number} onChange={this.handleChange} required />
                                ...
                                <div className="row m-0">
                                    ...
                                    <div className="col-12 col-md-6">
                                        <div className="form-group p-floating-container">
                                            ...
                                            <input type="email" className="form-control rounded-0" name="company_email" value={this.state.company_email} onChange={this.handleChange} autoComplete="off" />
                                ...
                                <div className="row m-0">
                                    <div className="col">
                                        <div className="form-group p-floating-container">
                                            ...
                                            <input type="text" className="form-control rounded-0" id="company_address" name="company_address" value={this.state.company_address} onChange={this.handleChange} autoComplete="off" />
                    ...
                    <div className="col-md-4 h-100 d-flex align-items-center" style={{ minHeight: "888px", position : "relative" , paddingLeft : "0"}}>
                        <img src={CompanyPageImg} alt="" className=" img-fluid h-100 my-auto" />
                        <div className="text-white pl-5  top-0 h-100 w-100 d-flex flex-column justify-content-around " style={{ backgroundColor: 'rgba(60,90,153,0.8)', position : "absolute" , top : "0px" , padding : "5rem 0"}}>
                            ...
                            <h4 className="mb-3">- Works like Website</h4>
