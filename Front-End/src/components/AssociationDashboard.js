...
export class CompanyDashboard extends Component {
    ...
    let one = `${KOKORUNS_BASE_URL}/association/${id}`
    ...
    axios.all([
     ...
     // this.setState({ associationbranches : responseTwo.data.associationbranches});
      ...
      handleSubmit(e) {
       ...
       axios.post(`${KOKORUNS_BASE_URL}/updateassociationinfo/${id}`, data, {headers: headers})
        .then((response) => {
      ...
      handleSubmit2(e) {
       ...
       axios.post(`${KOKORUNS_BASE_URL}/makecompanyadmin/${this.state.company_id}`, data, {headers: headers})
        .then((response) => {
      ...
      async handleSubmit3(e) {
        ...
        //   }
          ...
          try 
          {
              ...
              const response = await  axios.post(`${KOKORUNS_BASE_URL}/api/createassociationbranch/${this.state.company_id}`, data, {headers: headers});
    ...
    <div style={{background:'#f5f5dc'}}>
       ...
       <CHeader/>
        ...
        <div style = {{paddingTop: "0px !important"}} className="company-dashboard-body mb-5">
