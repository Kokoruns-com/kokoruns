...
export class Dashboard extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      employment_status: '',
      other_professions1: '',
      other_professions1_list: [],
      other_professions2: '',
      other_professions2_list: [],
      other_professions3: '',
      other_professions3_list: [],
      other_professions4: '',
      other_professions4_list: [],
      languages1: '',
      languages2: '',
      languages3: '',
      languages4: '',
  ...
  onChangeProfession = (e) => {
    ...
    axios.get(`${KOKORUNS_BASE_URL}/searchprofessions/${e.target.value}`, { headers: headers })
      .then(res => {
        const list = res.data[0];
        this.setState({ [`${e.target.name}_list`]: list });
      }).catch(err => {
        console.log(err);
      })
  }
  ...
  async componentDidMount() {
    ...
    var one = `${KOKORUNS_BASE_URL}/userdetails`
  ...
  async handleSubmit(e) {
    ...
    const data = {
      gender: this.state.gender, marital_status: this.state.marital_status,
    ...
    try {
      ...
      const response = await axios.post(`${KOKORUNS_BASE_URL}/api/updatebio`)
            ...
            <form onSubmit={this.handleSubmit} id="myform">
              ...
              <div className="row mt-3">
                <div className="col">
                  ...
                  <input onChange={this.onChangeProfession} className="form-control" type="text" name="other_professions1" value={this.state.other_professions1} />
                  <div className=" mt-3 " style={{ maxHeight: "100px", overflow: "auto" }}>
                    {this.state.other_professions1_list.map(element => {
                      return (
                        <p onClick={this.onClickProffession}
                          style={{ cursor: "pointer", fontSize: "16px" }}>{element} </p>
                      )
                    })}
                  </div>
                </div>
              ...
              <div className="row mt-3">
                <div className="col">
                  ...
                  <input onChange={this.onChangeProfession} className="form-control" type="text" name="other_professions2" value={this.state.other_professions2} />
                  <div className=" mt-3 " style={{ maxHeight: "100px", overflow: "auto" }}>
                    {this.state.other_professions2_list.map(element => {
                      return (
                        <p onClick={this.onClickProffession}
                          style={{ cursor: "pointer", fontSize: "16px" }}>{element} </p>
                      )
              ...
              <div className="row mt-3">
                <div className="col">
                  ...
                  <input className="form-control" type="text" name="other_professions3" value={this.state.other_professions3} />
                  <div className=" mt-3 " style={{ maxHeight: "100px", overflow: "auto" }}>
                    {this.state.other_professions3_list.map(element => {
                      return (
                        <p onClick={this.onClickProffession}
                          style={{ cursor: "pointer", fontSize: "16px" }}>{element} </p>
                      )
              ...
              <div className="row mt-3">
                <div className="col">
                  ...
                  <input className="form-control" type="text" id="current_employer" name="other_professions4" value={this.state.other_professions4} />
                  <div className=" mt-3 " style={{ maxHeight: "100px", overflow: "auto" }}>
                    {this.state.other_professions4_list.map(element => {
                      return (
                        <p onClick={this.onClickProffession}
                          style={{ cursor: "pointer", fontSize: "16px" }}>{element} </p>
                      )
