...
export class SchoolRegister extends Component {
    ...
    handleSubmit(e) {
        ...
        formData.append('School_name', e.target.School_name.value);
        formData.append('phone', e.target.School_number.value);
        formData.append('School_email', e.target.School_email.value);
        formData.append('cac', e.target.cac.value);
        formData.append('School_type', e.target.School_type.value);
        formData.append('School_size', e.target.School_size.value);
        formData.append('website', e.target.website.value);
        formData.append('School_address', e.target.School_address.value);
        ...
        formData.append('School_logo', e.target.School_logo.value);
        ...
        axios.post(`https://sheltered-chamber-63274.herokuapp.com/api/aregister`, formData, { headers: headers })
            .then((response) => {
                ...
                this.props.history.push(`/School-dashboard/${response.data.School.School_id}`);
                ...
                <div className="row bg-white mx-auto">
                    <div className="col-md-8">
                        <div className="pt-4 pl-4 pr-4">
                            <h3 className="mb-4">Create An School Pagee</h3>
                            ...
                            <form encType="multipart/form-data" onSubmit={this.handleSubmit} className="needs-validation">
                                <div className="row">
                                    <div className="col">
                                        <div className="form-group p-floating-container">
                                            <label className="text-primary">Enter School Name <span className="text-danger">*</span></label>
                                            <input type="text" className="form-control rounded-0" id="School_name" name="School_name" aria-label="School Name" maxLength={45} autoComplete="off" value={this.state.School_name} onChange={this.handleChange} required />
                                ...
                                <div className="row">
                                    <div className="col-12 col-md-6">
                                        <div className="form-group p-floating-container">
                                            <label className="text-primary">Enter School Phone No. <span className="text-danger">*</span></label>
                                            <input type="number" min={0} name="School_number" id="School_number" className="form-control rounded-0" value={this.state.School_number} onChange={this.handleChange} required />
                                    ...
                                    <div className="col-12 col-md-6">
                                        <div className="form-group p-floating-container">
                                            ...
                                            <input type="text" name="cac" id="cac" value={this.state.cac} onChange={this.handleChange} className="form-control rounded-0" />
                                ...
                                <div className="row">
                                    <div className="col-12 col-md-6">
                                        <div className="form-group p-floating-container">
                                            <label className="text-primary">Select School Type* </label>
                                            <select name="School_type" className="form-control rounded-0" value={this.state.School_type} onChange={this.handleChange} required>
                                    ...
                                    <div className="col-12 col-md-6">
                                        <div className="form-group">
                                            <label className="text-primary">Select School Size* </label>
                                            <select name="School_size" value={this.state.School_size} onChange={this.handleChange} className="form-control rounded-0" required>
                                                <option value> -- Select an option --</option>
                                ...
                                <div className="row">
                                    <div className="col-12 col-md-6">
                                        <div className="form-group p-floating-container">
                                            ...
                                            <input type="text" className="form-control rounded-0" name="website" value={this.state.website} onChange={this.handleChange} autoComplete="off" />
                                    ...
                                    <div className="col-12 col-md-6">
                                        <div className="form-group p-floating-container">
                                            ...
                                            <input type="email" className="form-control rounded-0" name="School_email" value={this.state.School_email} onChange={this.handleChange} autoComplete="off" />
                                ...
                                <div className="row">
                                    <div className="col text-center text-primary">
                                        <h6>Main School Location</h6>
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col">
                                        <div className="form-group p-floating-container">
                                            <label className="text-primary">Enter Main School Address </label>
                                            <input type="text" className="form-control rounded-0" id="School_address" name="School_address" value={this.state.School_address} onChange={this.handleChange} autoComplete="off" />
                                ...
                                <div className="row">
                                    <div className="col text-center">
                                        <div className="mx-auto">
                                            ...
                                            <input type="file" className="input-id" id="School_logo" name="School_logo" value={this.state.School_logo} onChange={this.handleChange} data-browse-on-zone-click="true" accept="image/*" />
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="col-md-4 h-100 d-flex align-items-center" style={{ minHeight: "888px", position : "relative" , paddingLeft : "0"}}>
                        <img src={SchoolPageImg} alt="" className=" img-fluid h-100 my-auto" />
                        <div className="text-white pl-5  top-0 h-100 w-100 d-flex flex-column justify-content-around " style={{ backgroundColor: 'rgba(60,90,153,0.8)', position : "absolute" , top : "0px" , padding : "5rem 0"}}>
                            <h4 className="mb-3"> - Find Talents</h4>
                            <h4 className="mb-3">- Post Jobs</h4>
                            <h4 className="mb-3">- Works like a website</h4>
                            <h4 className="mb-3">- Promote Your Brand</h4>
                            <h4 className="mb-3">- Add other Sub-admins</h4>
                        </div>
                    </div>
                </div>
            </div>
