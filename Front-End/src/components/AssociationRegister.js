...
export class AssociationRegister extends Component {
    ...
    async componentDidMount() {
        ...
        let one = `${KOKORUNS_BASE_URL}/userdetails`
    ...
    handleSubmit(e) {
        ...
        axios.post(`${KOKORUNS_BASE_URL}/aregister`, formData, { headers: headers })
            .then((response) => {
                ...
                <div className="row bg-white mx-auto">
                    <div className="col-md-8">
                        <div className="pt-4 pl-4 pr-4">
                            <h3 className="mb-4">Create An Association Page</h3>
                                ...
                                <div className="row">
                                    <div className="col">
                                        <div className="form-group p-floating-container">
                                            ...
                                            <input type="text" className="form-control rounded-0" id="Association_name" name="association_name" aria-label="Association Name" maxLength={45} autoComplete="off" value={this.state.Association_name} onChange={this.handleChange} required />
                                ...
                                <div className="row">
                                    <div className="col-12 col-md-6">
                                        <div className="form-group p-floating-container">
                                            ...
                                            <input type="number" min={0} name="association_number" id="Association_number" className="form-control rounded-0" value={this.state.Association_number} onChange={this.handleChange} required />
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-12 col-md-6">
                                        <div className="form-group p-floating-container">
                                            ...
                                            <input type="email" className="form-control rounded-0" name="association_email" value={this.state.Association_email} onChange={this.handleChange} autoComplete="off" />
                                ...
                                <div className="row">
                                    <div className="col">
                                        <div className="form-group p-floating-container">
                                            ...
                                            <input type="text" className="form-control rounded-0" id="Association_address" name="association_address" value={this.state.Association_address} onChange={this.handleChange} autoComplete="off" />
                    ...
                    <div className="col-md-4 h-100 d-flex align-items-center" style={{ minHeight: "888px", position : "relative" , paddingLeft : "0"}}>
                        <img src={AssociationPageImg} alt="" className=" img-fluid h-100 my-auto" />
                        <div className="text-white pl-5  top-0 h-100 w-100 d-flex flex-column justify-content-around " style={{ backgroundColor: 'rgba(60,90,153,0.8)', position : "absolute" , top : "0px" , padding : "5rem 0"}}>
                            <h4 className="mb-3">- Find Members</h4>
                            <h4 className="mb-3">- Add Members</h4>
                            <h4 className="mb-3">- Broadcast to Members</h4>
                            <h4 className="mb-3">- Create Events</h4>
                            <h4 className="mb-3">- Pay For Membership</h4>
                        </div>
                    </div>
                </div>
            </div>
