 ...
 async componentDidMount()
  {
    ...
    try
    {
       ...
       const response = await axios.get(`${KOKORUNS_BASE_URL}/api/userdetails`, {headers: headers});
  ...
  async handleSubmit(e) {
    ...
    //Display the key/value pairs
      ...
      {
          // fetch data from a url endpoint
          const response = await  axios.post(`${KOKORUNS_BASE_URL}/api/changeprofilepic`, formData, {headers: headers});
    ...
    render() {
        ...
        return (
            ...
            {/*-------VIEW AND HIDE BIO BUTTONS-------*/}            
            <div align="center" className="sections row" style = {{columnGap : "0", padding : "0 1% ", margin: "0"}}>
                 <div className=" col-12 col-md-4 my-2">    
                    <Link to={"/user-dashboard-experience"}><button  id="exp-b" className="sections-div-active font-weight-bold"> Experience </button> </Link>
                </div>
                <div className=" col-12 col-md-4 my-2">      
                    <Link to={"/user-dashboard-education"}><button id="edu-b" className="sections-div font-weight-bold">Education</button></Link>
                </div>
                <div className=" col-12 col-md-4 my-2">    
                    <Link to={"/user-dashboard-portfolio"}><button id="port-b" className="sections-div font-weight-bold">Portfolio</button></Link>
                </div>
