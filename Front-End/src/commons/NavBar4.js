        ...
        return (
                  <div className="row" style={{marginTop: '2rem'}}>
                    <div className="col-lg-11 mx-auto px-0" style={{width: '70%'}}>
                      <div className="p-3 bg-dark background_image w-100" style={{backgroundImage: 'url("/assets/Css/CompanyDashboard/image/company banner.jpg")', backgroundColor: '#cccccc', minHeight: 305, backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundSize: 'cover'}}>
                        <div className="row py-2">
                          <div className="col-lg-1 col ">
                            {/* <i class="far fa-envelope text-white" style="font-size: 1.5rem;"></i> */}
                            <img src="/assets/Images/User%20Profile/Inbox%20Logo.png" alt= "" width="55%" className = "" />
                          </div>
                          <div className="col-lg-6 col text-right pt-3" style={{paddingRight: '1.3rem'}}>
                            <img src="Company%20Logo.png" style={{border: '10px solid #fff'}} alt="logo" width="120px" height="120px" />
                          </div>
                          <div className="col-lg-5 col text-right">
                        ...
                        <div className="row py-2">
                          <div className="col-lg-12 text-center text-white">
                            <h4 className="header-title" data-toggle="tooltip" data-placement="bottom" title="<?php echo ucwords(strtolower($company_details['fcompany_name'])); ?>" style={{fontSize: 45}}> 
                              {this.state.company_name ? this.state.company_name : "Company Name"}
                            </h4>
                          </div>
                        </div>
                        <div className="row py-2">
                          <div className=" col-12 col-md m-0 p-1">
