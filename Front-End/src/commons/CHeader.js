...
class CHeader extends Component {
    ...
    render() {
        ...
        return (
            ...
            <>
                <header className="bg-white w-100" style={{ position: 'initial', top: 0, width: '100%', zIndex: 9, borderBottom: '1px solid #ccc' }}>
                    <nav>
                        <div className="row">
                            ...
                            <div className="col-10 col-md-6 pt-3 text-center">
                                <div className="input-group mb-2 w-100 mx-4">
                                    <input type="text" className="rounded-0 header-search-bar  w-75" placeholder="Search for something..." style={{ backgroundImage: 'linear-gradient(45deg, #0691f8, #0691f8, #b73650)', width: '87.5% !important', border: '1px solid #ced4da', height: '2.5rem', display : "block !important" }} />
                            ...
                            <div className="col-2 col-md-3 text-center pt-3">
                                <a className href="<?php echo site_url(); ?>user/dashboard"> <i className="fas fa-arrows-alt-h" /></a>
                                <a href="<?php echo site_url(); ?>logout" className="pt-4 h4" onclick="return confirm('Are you sure you want to logout?')">
