...
export class Header extends Component {
    ...
    async componentDidMount() {
        ...
        let one = `${KOKORUNS_BASE_URL}/companies`
        let two = `${KOKORUNS_BASE_URL}/associations`;
        ...
        axios.all([
            ...
            this.setState({
                companies: responseOne.data.companies, associations: responseTwo.data.associations,
            });
    ...
    render() {
        ...
        return (
            ...
            <header className="bg-white header-class " style={{ borderBottom: '1px solid #ccc', maxHeight: "450px", position: "static" }}>
                <div className="row">
                    <div className="col-12  col-md-3 text-center text-md-left">
                        <div className="pt-3 pl-2">
                            <a href="/">
                                <img src="assets/Images/Header%20and%20Footer/Logo.png" width="55%" />
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="col text-center">
                        <div className="pt-4">
                            <div className="dropdown">
                                <span style={{ cursor: "pointer" }} data-toggle="dropdown" className=" font-weight-bold">Add Page </span>
                                <div className="dropdown-menu shadow border-0 mt-1">
                                    <Link className="dropdown-item font-weight-bold" to="/company-register">Create Company Page</Link>
                                    <div className="dropdown-divider" />
                                    <Link className="dropdown-item font-weight-bold" to="/association-register">Create Association Page</Link>
                                    <div className="dropdown-divider" />
                                    <Link className="dropdown-item font-weight-bold" to="/school-register">Create School Page</Link>
                                </div>
                            </div>
                        </div>
                    </div>
