...
<body>
   <div class="login-form-container" align="center">
        <div id="rounded-corner" align="center" class="form-table">
              <div align="center">
              <label><h2 class="login-label">Login&nbsp;<b class="label-tag">Company</b></h2></label>
            ...
            <form action="<?php echo site_url()?>front/cloginaction" method="POST">
              ...
              <br>
                  <p><a class="forgot-password" href="<?php echo site_url();?>forgot">Forgot Password?</a>
                      <br><br>
                  <a  class="create-account" href="<?php echo site_url();?>cregister">Create Account</a></p>
              </div>
              </div>
        </div>
