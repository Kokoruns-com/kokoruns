...
<body>
   ...
   <form action="<?php echo site_url()?>front/registerverifyphoneaction" method="POST">
        <div id="rounded-corner" align="center" class="form-table">
              ...
              <br>
              <br> 
              <label align="center" class="remember-me-ondevice" for=""> Please check your phone inbox for a message with your code.</label>
              <br>
              <br>
              <div>
              ...
              <p> Didn't get verification code? Use Resend Code link below and resend code</p>
                ...
                <div class="p-3" id="create-event-box">
                  
                    <form action="<?php echo site_url(); ?>front/verificationphoneresend" method="post">
                    
                        <p><input type="hidden" name="email" value="<?php echo session()->show_resend_email; ?>"></p>
