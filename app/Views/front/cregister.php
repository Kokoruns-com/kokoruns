...
<body>
 ...
 <div align="center" class="company-reg-form-container">
  <form action="<?php echo site_url()?>front/cregisteraction" method="POST">
        <div id="rounded-corner" align="center" class="form-table">
            <div><div align="center"><label><h1 class="login-label">Company Registration</h1></label></div></div>
            ...
            Company Name<b>*</b></div>
            <input class="form-input" type="text" id="company_name" name="company_name" placeholder="" required>  
            </div>
                  
            <div align="left" class="h3-label">
            <div style="padding-bottom: 10px">
            CAC Reg. Number<b></b></div>
            ...
            <input class="form-input" type="email" id="company_email" name="company_email" placeholder="" required>  
            </div>

            <div align="left" class="h3-label">
            <div style="padding-bottom: 10px">
            Password<b>*</b>(Minimum of 8 characters)</div>
            <input class="form-input" type="password" id="company_pword" name="company_pword" placeholder="" required>  
            </div>

            <div align="left" class="h3-label">
            <div style="padding-bottom: 10px">
            Confirm Password<b>*</b></div>
            <input class="form-input" type="password" id="confrim_company_pword" name="confrim_company_pword" placeholder="" required>  
            </div>
                  
            <div align="left" class="h3-label">
            <div style="padding-bottom: 10px">
            Contact Phone Number<b>*</b></div>
            <input class="form-input" type="number" id="company_number" name="company_number" placeholder="" required>  
            </div>  
            ...
            <div colspan="2" align="center">
              ...
              <button type="submit" class="Register-company-button" id="">Register Company</button>
              <br>
              <br>
    </form>
                  <p>
                  <a class="back-to-home" href="<?php echo site_url();?>clogin">Login</a></p>
            </div>
