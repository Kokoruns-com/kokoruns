...
<body>
 ...
 <div align="center" class="company-reg-form-container">
     <form action="<?php echo site_url()?>front/sregisteraction" method="POST">
        <div id="rounded-corner" align="center" class="form-table">
            <div><div align="center"><label><h1 class="login-label">School Registration</h1></label></div></div>
            ...
            School Name<b>*</b></div>
            <input class="form-input" type="text" id="school_name" name="school_name" placeholder="" required>  
            </div>
            ...
            <input class="form-input" type="email" id="school_email" name="school_email" placeholder="" required>  
            </div>

            <div align="left" class="h3-label">
            <div style="padding-bottom: 10px">
            Password<b>*</b>(Minimum of 8 characters)</div>
            <input class="form-input" type="password" id="school_pword" name="school_pword" placeholder="" required>  
            </div>

            <div align="left" class="h3-label">
            <div style="padding-bottom: 10px">
            Confirm Password<b>*</b></div>
            <input class="form-input" type="password" id="confrim_school_pword" name="confrim_school_pword" placeholder="" required>  
            </div>
                  
            <div align="left" class="h3-label">
            <div style="padding-bottom: 10px">
            Contact Phone Number<b>*</b></div>
            <input class="form-input" type="number" id="school_number" name="school_number" placeholder="" required>  
            </div>  
                  
            <div align="left" class="h3-label">
            <div style="padding-bottom: 10px">
            Main School Location<b>*</b></div>
            ...
            <div colspan="2" align="center">
              ...
              <button type="submit" class="Register-company-button" id="">Register School</button>
              <br>
              <br>
    </form>
                  <p>
                  <a class="back-to-home" href="<?php echo site_url(); ?>slogin">Login</a></p>
            </div>
