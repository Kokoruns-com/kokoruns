...
<body>
   ...
   <form action="<?php echo site_url()?>front/RegisterVerifyEmailAction" method="POST">
        <div id="rounded-corner" align="center" class="form-table">
              ...
              <br> 
                  ...
                  <form action="<?php echo site_url(); ?>front/verificationemailresend" method="post">
                        ...
                        <p><input type="hidden" name="email" value="<?php echo session()->show_resend_email; ?>" required></p>
                       

                         <button type="submit" class="btn btn-dark"> Resend Code </button>
                  </form>
                  <br>
                  <br>
              </div>
