...
<body>
   ...
   <form action="<?php echo site_url()?>front/sloginaction" method="POST">
        <div id="rounded-corner" align="center" class="form-table">
              <div align="center">
              <label><h2 class="login-label">Login&nbsp;<b class="label-tag">Schools</b></h2></label>
              ...
              <br>
                  <p><a class="forgot-password" href="<?php echo site_url();?>forgot">Forgot Password?</a>
                      <br><br>
                  <a  class="create-account" href="<?php echo site_url();?>sregister">Create Account</a></p>
              </div>
              </div>
        </div>
    </form>
