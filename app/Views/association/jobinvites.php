  ...
  cursor:pointer;
    ...
    <div class="">
            ...
            <h2 class="company-profile-headerd text-center">
                Received Applications for <small><?php if(!empty($job_invite_messages)){echo $job_invite_messages[0]['fjob_title'];} ?></small>
            </h2>
        ...
        <div class="company-profile-container" >
                     ...
                     <div class="w3-responsive">
                            <table class="w3-table w3-bordered datatable">
                              ...
                              <?php foreach($job_invite_messages as $invite){ ?>

                                <tr>
                                    
                                    <td><?php echo $invite['fsender_id']; ?></td>
                                    <td> <a href="<?php echo site_url();?>employer/message/details/<?php echo $invite['fjob_id']; ?>/<?php echo $invite['fsender_id']; ?>">View</a></td>
