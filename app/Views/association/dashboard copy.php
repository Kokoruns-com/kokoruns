...
.cursor{
  cursor:pointer;
    ...
    <div align="center" class="company-name">Together Club, Lagos</div>           
    ...
    <div id="CompanyInfoCont" align="center" class="company-info-container">
     ...
     <a target="_blank" href="#">www.association.com</a><br>
    ...
    document.getElementById("Gallery").style.display="block";    
        ...
        <div class="form-about-label">About</div>
            ...
            <div class="textarea-div">
                ...
                <textarea class="form-about-textarea" name="about"><?php echo $association_details['fabout']; ?></textarea>
        ...
        <?php $locations = explode("-", $association_details['flocations']); ?>
        ...
        <?php $socials = explode("-", $association_details['fsocials']); ?>
    ...
    <div id="AddEventForm" class="add-event-container-padding">
        ...
        <input type="hidden" id="association_id" name="association_id" value="<?php echo $association_details['fassociation_id']; ?>">
            ...
            <div class="row porfolio-container-imagesc">
                    ...
                    <?php foreach ($association_gallery as $portfolio) {?>
                        ...
                        <div class="col-sm-4 mb-5">
                            <img class="image" src="<?php echo site_url('public/associationgalleries/'.$portfolio['fimage']);?>" width="100%">
...
$("#edit-profile-form").submit(function(){
    ...
    $.ajax({
        url: '<?php echo site_url(); ?>association/updateprofileaction',
        type: "POST",
        data: querystring,
        dataType: "json",
...
<script>
    ...
    function loadassociationprofile()
      {
          $.ajax({
          url:"<?php echo site_url(); ?>association/loadassociationprofile",
          method:"POST",
          dataType:"json",
          success:function(data)
          {
            ...
            //alert(data.association_profile);

            $('#company-profile-container').html(data.association_profile);
...
<script>
    ...
    //alert(querystring);
        ...
        $.ajax({
            url: '<?php echo site_url(); ?>association/updateeventaction',
            type: "POST",
            data: querystring,
            dataType: "json",
            success: function(response) {
