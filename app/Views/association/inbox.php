        ...
        <section class="company-profile" style="padding-bottom:30px;">
            ...
            <section id="team-box-divd" class="user-experiencesx">
                ...
                <div  class="experience-post-container" >
                    ...
                    <form class="" action="<?php echo site_url(); ?>association/createmessageaction" method="post">
                        ...
                        <div class="row">
                                ...
                                <div class="col-lg-10">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="sender_id" value="<?php echo $association_details['fassociation_id']; ?>">
                ...
                <div class="">
                    ...
                    <div class="row">
                            ...
                            <div class="experience_box"> 
                                    ...
                                    <li><strong><a href="<?php echo site_url();?>association/messages/inbox" class="text-dark"> Inbox </a> </strong> (<?php echo $inbox_count; ?>)</li>
                                    <li><strong><a href="<?php echo site_url();?>association/messages/sent" class="text-dark">Sent </a> </strong>(<?php echo $sent_count; ?>)</li>
                                    </ul>
                                ...
                                <tbody>
                                   <?php foreach ($inbox as $message) {?>
                                     ...
                                     <tr width="1%">
                                        ...
                                        <td width="73%"><a href="<?php echo site_url('association/emaildetails/'. $message['fmessage_id']); ?>"><strong><?php echo $message['fsubject']; ?></strong></a></td>
                                     </tr>
