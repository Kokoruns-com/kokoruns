...
.cursor{
  cursor:pointer;
    ...
    <div align="center" class="company-name">Joy School, Lagos</div>           
    ...
    <div id="CompanyInfoCont" align="center" class="company-info-container">
     ...
     <a target="_blank" href="#">www.joyschool.com</a><br>
    ...
    document.getElementById("Gallery").style.display="block";    
        ...
        <section id="CompanyProfile" class="company-profile">
            ...
            <div class="company-profile-header-container">
        <h2 align="center" class="company-profile-header">
        School Profile    
        </h2>
             
                <div id="EditProfileButton" class="edit-profile-button-div">
        ...
        <div class="form-about-label">About</div>
            ...
            <div class="textarea-div">
                ...
                <textarea class="form-about-textarea" name="about"><?php echo $school_details['fabout']; ?></textarea>
        ...
        <?php $locations = explode("-", $school_details['flocations']); ?>
        ...
        <?php $socials = explode("-", $school_details['fsocials']); ?>
        ...
        <h2 align="" class="company-events-header cursor">
            Events</h2>
            
        <div id="AddEventButton" class="add-event-button-container">
    ...
    <div id="AddEventForm" class="add-event-container-padding">
        ...
        <input type="hidden" id="school_id" name="school_id" value="<?php echo $school_details['fschool_id']; ?>">
    ...
    <div id="posted-event-container">
        ...
        <div align="center" class="company-gallery-header-container">
        ...
        <div class="add-image-button-container">   
            ...
            <?php //if(empty($school_gallery)) { ?>
                  
                  <!-- <div class="posted-event-container">
                      <p style="text-align:center">Seems you have no gallery yet. Add a new photo to get started.</p>
                  </div> -->

                  
                  <!-- <div class="row">

            <?php //} else {  foreach ($school_gallery as $gallery) { ?>
               
                
                    <div class="col-sm-4">
                        <a class="" >
                        <img class="" src="<?php //echo base_url('/public/galleries/'. $gallery['fimage']);?>"></a>
                        <span class="delete-image text-danger cursor" data-image_id="<?php //echo $gallery['fimage_id']; ?>" data-image_name="<?php echo $gallery['fimage']; ?>" style="position:relative; top: -93px; left:-13px;">x</span>
                    </div>
            ...
            <div class="row porfolio-container-imagesc">
                    ...
                    <?php foreach ($school_gallery as $portfolio) {?>
                    
                        <div class="col-sm-4 mb-5">
                            <img class="image" src="<?php echo site_url('public/schoolgalleries/'.$portfolio['fimage']);?>" width="100%">
                            <span data-image_id="<?php echo $portfolio['fimage_id'];?>" data-image_name="<?php echo $portfolio['fimage'];?>" class="fa fa-times text-danger cursor delete-image" style="position:relative;top:-90px;right:35px;"></span>
                        </div>
...
$("#edit-profile-form").submit(function(){
    ...
    $.ajax({
        url: '<?php echo site_url(); ?>school/updateprofileaction',
        type: "POST",
        data: querystring,
        dataType: "json",
...
<script>
    ...
    function loadschoolprofile()
      {
          $.ajax({
          url:"<?php echo site_url(); ?>school/loadschoolprofile",
          method:"POST",
          dataType:"json",
          success:function(data)
          {
            ...
            //alert(data.school_profile);

            $('#company-profile-container').html(data.school_profile);
...
$("#add-event-form").submit(function(){
    ...
    $.ajax({
        url: '<?php echo site_url(); ?>school/createeventaction',
        type: "POST",
        data: querystring,
        dataType: "json",
        success: function(response) {
...
<script>
        ...
        $("body").on('click' ,'.event-delete', function(e){
            ...
            $.ajax({
                url: '<?php echo site_url();?>school/deleteeventaction',
                method:"POST",
                dataType: "json",
...
<script>
    ...
    function loadschoolevents()
      {
          $.ajax({
          url:"<?php echo site_url(); ?>school/loadschoolevents",
          method:"POST",
          dataType:"json",
          success:function(data)
          {
           ...
           $('#posted-event-container').html(data.school_events);
    ...
    //alert("Hi");
        ...
        //console.log(files); 
            ...
            //console.log(form_data);
                ...
                $.ajax({
                    url: '<?php echo site_url();?>school/uploadgalleryaction',
                    type: 'post',
                    contentType: false,
                    processData: false,
                    //dataType: "json",
...
<script>
        ...
        // $('.delete-image').click(function (e) {
            ...
            $.ajax({
                url: '<?php echo site_url();?>school/deletegalleryaction',
                method:"POST",
                dataType: "json",
