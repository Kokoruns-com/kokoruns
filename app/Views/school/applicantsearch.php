...
<div class="company-profile-container">
            ...
            <?php } else { ?>
                ...
                <form action="<?php echo site_url(); ?>school/jobinviteaction" method="post">
                    <input type="hidden" name="employer_id" value="<?php echo $school_details['fschool_id']; ?>">
                    <input type="hidden" name="employer_name" value="<?php echo $school_details['fschool_name']; ?>">
