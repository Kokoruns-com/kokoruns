...
<form action="<?php echo site_url();?>school/createjobaction" method="post">
<input type="hidden" name="school_id" value="<?php echo $school_details['fschool_id']; ?>">
<input type="hidden" name="school_name" value="<?php echo $school_details['fschool_name']; ?>">
        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col text-center">
                    <button id="job_submit" type="submit" class="w3-button w3-blue" onclick="return confirm('Are you sure you want to create this job?')">CONTINUE</button>
                </div>
            </div> 
    </form>  
                            ...
                            <table class="w3-table w3-bordered datatable">
                              ...
                              <?php foreach($jobs as $job){ ?>
                                ...
                                <tr>
                                    ...
                                    <td>Active</td>
                                    <td>
                                        <a href="<?php echo site_url();?>school/job/<?php echo $job['fjob_id']; ?>">View</a>
                                    </td>
                                </tr>
