        ...
        <section class="company-profile" style="padding-bottom:30px;">
            ...
            <section id="team-box-divd" class="user-experiencesx">
                ...
                <div  class="experience-post-container" >
                    ...
                    <form class="" action="<?php echo site_url(); ?>company/createmessageaction" method="post">
                        ...
                        <div class="row">
                                ...
                                <div class="col-lg-10">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="sender_id" value="<?php echo $company_details['fcompany_id']; ?>">
                                        <input type="hidden" name="sender_name" value="<?php echo $company_details['fcompany_name'] ; ?>">
                ...
                <div class="">
                    ...
                    <div class="row">
                            ...
                            <div class="experience_box"> 
                                    ...
                                    <li><strong><a href="<?php echo site_url();?>company/messages/inbox" class="text-dark"> Inbox </a> </strong> (<?php echo $inbox_count; ?>)</li>
                                    <li><strong><a href="<?php echo site_url();?>company/messages/sent" class="text-dark">Sent </a> </strong>(<?php echo $sent_count; ?>)</li>
                                    </ul>
