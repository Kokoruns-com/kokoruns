...
<div class="company-profile-container">
            ...
            <?php } else { ?>
                ...
                <form action="<?php echo site_url(); ?>company/jobinviteaction" method="post">
                    <input type="hidden" name="employer_id" value="<?php echo $company_details['fcompany_id']; ?>">
                    <input type="hidden" name="employer_name" value="<?php echo $company_details['fcompany_name']; ?>">
