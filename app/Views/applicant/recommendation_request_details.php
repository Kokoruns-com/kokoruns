...
<div  class="experience-post-container">
    ...
    <div id="" class="">
        ...
        <h3>This Person Asked For Your Recommendation</h3>
                ...
                <br>
                 ...
                 <div class="row">
                    <div class="col s12">
                    <p for=""> <strong> Name:</strong> <?php echo $recommendation_request['fsender_name']; ?></p>
                    <p for=""> <strong> Claimed Relationship With You:</strong> <?php echo $recommendation_request['frelationship']; ?></p>
                     <p> <strong>Claimed Position At The Time Of Relationship: </strong> <?php echo $recommendation_request['frelationship-position']; ?></p>
                ...
                <?php if($recommendation_request['faccepted'] == 0){ ?>
                        <div class="row">
                            ...
                            <div class="col-sm-6 text-center">
                                <a href="<?php echo site_url('applicant/recommendation/request/accept/'. $recommendation_request['frecno']); ?>" class="btn btn-success">ACCEPT</a>
                            </div>
                            <form action="<?php echo site_url('/applicant/recommendationrequestreject/'. $recommendation_request['frecno']); ?>" method="post">
                                <div class="col-sm-6 text-center">
                ...
                <?php }else if($recommendation_request['faccepted'] == 1){ ?>
                    <div class="row">
                        
                        <div class="col-sm-12 text-center">
                            <a href="<?php echo site_url('applicant/recommendation/request/reject/'. $recommendation_request['frecno']); ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to revoke your recommendation?')">REVOKE RECOMMENDATION</a>
                        </div>
