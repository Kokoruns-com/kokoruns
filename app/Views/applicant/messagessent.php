...
<section id="" style="margin-top: 2.85rem;">
        ...
        <div class="experience_box"> 
                ...
                <ul class="w3-ul w3-border" style="width:100%">
                  <li><strong><a href="<?php echo site_url();?>applicant/messages/inbox" class="text-dark"> Inbox </a> </strong> (<?php echo $inbox_count; ?>)</li>
                  <li><strong><a href="<?php echo site_url();?>applicant/messages/sent" class="text-dark">Sent </a> </strong>(<?php echo $sent_count; ?>)</li>
                </ul>
            ...
            <section id="team-box-divd" class="user-experiences">
                   ...
                   <h6 class="text-center"><a href="<?php echo site_url();?>applicant/messages/inbox">Back To Inbox</a></h6>
                ...
                <div id="compose-box" class="experience-post-container" style="display:none">
                    ...
                    <form class="" action="<?php echo site_url(); ?>applicant/createmessageaction" method="post">
                        ...
                        <label for="" class="col-lg-2">To: *</label>
                                <div class="col-lg-10">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control search_applicants" name="to" placeholder="Seach for name" required>
                                    ...
                                    <tbody>
                                       <?php foreach ($sent as $message) {?>
                                         ...
                                         <tr width="1%">
                                            ...
                                            <td width="25%"><strong><?php echo $message['fsender_name']; ?></strong></td>
                                            <td width="73%"><a href="<?php echo site_url('message/'. $message['fmessage_id']); ?>"><strong><?php echo $message['fsubject']; ?></strong></a></td>
                                         </tr>
