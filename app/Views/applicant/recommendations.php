        ...
        <section class="">    
            ...
            <div class="">
                ...
                <h1 class="skills-header w3-center">
                   Recommendation Request <span class="btn btn-primary" onclick="RequestRecommendationsFunction();">Add New</span>
...
<div  class="experience-post-container">
    ...
    <div id="request_recommendation_box" class="exp-cont w3-white" style="display:none;">

    <div class="experience_box"> 

    <h3>Request Recommendation </h3>
        
    <form class="" action="<?php echo site_url();?>applicant/recommendation/request" method="post">
            ...
            <div class="row">
                ...
                <label for="">To: <span class="text-danger">*</span></label>
                    <input type="text" class="form-control search_applicants applicant_id" placeholder="Enter name of receiver" required>
                    <input type="hidden" name="receiver_id" id="applicant_id">
                    <div class="suggestion-box w3-light-grey">
                                            
                    </div>
                    <input type="hidden" name="sender_id" value="<?php echo $applicant_details['fapplicant_id']; ?>">
                    <input type="hidden" name="sender_name" value="<?php echo $applicant_details['ffirst_name']. ' ' . $applicant_details['flast_name']; ?>">
                    <input type="hidden" name="sender_job_title" value="<?php echo $applicant_details['fprofession']; ?>">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                <label for="">Your Relationship: <span class="text-danger">*</span></label>
                    <!-- <input type="text" class="form-control" name="subject" id="" value="Recommendation Request" readonly style="background:#fafafa;"> -->
                    <select name="relationship" id="" class="form-control" required>
                        <option value="">Select one</option> 
                        <optgroup label="Former">
                            <option value="Former Colleague">Colleague</option>
                            <option value="Former Boss">Boss</option>
                            <option value="Former Employer">Employer</option>
                            <option value="Former School Mate">School Mate</option>
                            <option value="Former Mentor">Mentor</option>
                            <option value="Former Teacher">Teacher</option>
                            <option value="Former Student">Student</option>
                            <option value="Former Client">Client</option>
                            <option value="Former Customer">Customer</option>
                        </optgroup>
                        <optgroup label="Present">
                            <option value="Present Colleague">Colleague</option>
                            <option value="Present Boss">Boss</option>
                            <option value="Present Employer">Employer</option>
                            <option value="Present School Mate">School Mate</option>
                            <option value="Present Mentor">Mentor</option>
                            <option value="Present Teacher">Teacher</option>
                            <option value="Present Student">Student</option>
                            <option value="Present Client">Client</option>
                            <option value="Present Customer">Customer</option>
                        </optgroup>
                    </select>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                <label for="">Your Position At The Time Of Relationship: <span class="text-danger">*</span></label>
                    <select name="relationship-position" id="" class="form-control" required>
                        <option value="">Select one</option> 
                     <?php foreach ($applicant_experiences as $experience) { ?>
                            <option value="<?php echo $experience['fposition']; ?>"><?php echo $experience['fposition']; ?></option> 
                        <?php } ?>
                    </select>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <label for="">Message:</label>
                    <textarea name="message" class="form-control" id="" cols="30" rows="5"> I wish to have your recommendation</textarea>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <button type="submit" class="w3-button w3-black w3-right" onclick="return confirm('Are you sure you want to send this request?')">Send</button>
...
<br>
    ...
    <div class="exp-cont w3-white">
        ...
        <h3>Received Requests</h3>
            <div class="w3-responsive text-center">
                <table class="w3-table w3-bordered w3-striped table_id text-center">
                    <thead>
                    <tr>
                    ...
                    <tbody>
                <?php foreach($received_recommendation_requests as $request){?>
                        <tr class="text-center">
                            <td><a href=""><?php echo $request['fsender_name']; ?></a></td>
                            <td><a href=""><?php echo $request['fsender_job_title']; ?></i></a></td>
                            <td><a href=""><?php echo date('M j, Y', strtotime($request['created_at'])); ?></i></a></td>
                            <td><a href="<?php echo site_url('applicant/recommendation/request/details/'. $request['frecno']); ?>">View</a></td>
                            <td><?php if($request['faccepted'] == 1){echo "Accepted";}else if($request['faccepted'] == 0){echo "Pending";}else if($request['faccepted'] == -1){echo "Rejected";}else if($request['faccepted'] == -2){echo "Revoked";}; ?></td>
                        </tr>
                <?php } ?>
                    </tbody>
                </table>
    ...
    <div class="exp-cont w3-white">
        ...
        <h3>Sent Requests</h3>
            <div class="w3-responsive">
                <table class="w3-table w3-bordered w3-striped table_id">
                    <thead>
                    <tr>
                    ...
                    <tbody>
                   <?php foreach($sent_recommendation_requests as $request){?>
                        <tr>
                            <td><a href=""><?php echo $request['freceiver_name']; ?></a></td>
                            <td><a href=""><?php echo $request['freceiver_job_title']; ?></i></a></td>
                            <td><a href=""><?php echo date('M j, Y', strtotime($request['created_at'])); ?></i></a></td>
                            <td><a href="<?php echo site_url('applicant/recommendation/request/details/'. $request['frecno']); ?>">View</a></td>
                            <td><?php if($request['faccepted'] == 1){echo "Accepted";}else if($request['faccepted'] == 0){echo "Pending";}else if($request['faccepted'] == -1){echo "Rejected";}else if($request['faccepted'] == -2){echo "Revoked";}; ?></td>
                        </tr>
...
<h1 class="skills-header w3-center">
                   Recommendation Offer <span class="btn btn-primary" onclick="OfferRecommendationsFunction();">Add New</span>
    ...
    <div id="" class="">
            ...
            <div id="offer_recommendation_box" class="exp-cont w3-white" style="display:none;">

            <div  class="experience_box" > 


        <h3>Offer Recommendation</h3>
                
               <form class="" action="<?php echo site_url(); ?>applicant/recommendation/offer" method="post">
                 ...
                 <div class="row">
                    <div class="col s12">
                    <label for="">To: <span class="text-danger">*</span></label>
                        <input type="search" class="w3-input w3-border search_applicants"  placeholder="Search for Name" required>
                        <input type="hidden" name="receiver_id" id="receiver_id">
                        <input type="hidden" name="receiver_name" id="receiver_name">
                        <input type="hidden" name="receiver_job_title" id="receiver_job_title">
                        <div class="suggestion-box w3-light-grey">
                    ...
                    <div class="row">
                        ...
                        <!-- <label for="">Topic:</label>
                            <input type="text" class="w3-input w3-border" name="subject" id="" value="Recommendation Offer" readonly style="background:#fafafa;"> -->
                            <label for="">Your Relationship: <span class="text-danger">*</span></label>
                            <select name="relationship" id="" class="form-control" required>
                                <option value="">Select one</option> 
                                <optgroup label="Former">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                        <label for="">Message:</label>
                            <textarea name="message" class="w3-input w3-border" id="" cols="30" rows="5"> I will like to recommend you </textarea>
                        </div>
                    </div>

                    <br>

                   <label for="">Personality Score of This Person (Select the options you will like to score and choose a scale)</label> 

                <div>
                    <input type="checkbox" class="w3-check" name="" id="gen_impression" required> <strong> General Impression <span class="text-danger">*</span></strong>
...
<br>
                ...
                <div>
                    ...
                    <div class="row">
                        ...
                        <div class="col s12">
                            <button type="submit" class="w3-button w3-black w3-right" id="recommendation_offer_submit" onclick="return confirm('Are you sure you want to recommend this person?')">Recommend</button>
                        </div>
            ...
            <div id="" class="">
                ...
                <div class="exp-cont w3-white">
                    ...
                    <h3>Received Recommendation Offers</h3>
                        <div class="w3-responsive">
                            <table class="w3-table w3-bordered w3-striped table_id ">
                                <thead>
                                <tr>
                                ...
                                <tbody>
                                    <?php foreach($received_recommendation_offers as $request){?>
                                            <tr>
                                                <td><a href=""><?php echo $request['fsender_name']; ?></a></td>
                                                <td><a href=""><?php echo $request['fsender_job_title']; ?></i></a></td>
                                                <td><a href=""><?php echo date('M j, Y', strtotime($request['created_at'])); ?></i></a></td>
                                                <td><a href="<?php echo site_url('applicant/recommendation/offer/details/'. $request['frecno']); ?>">View</a></td>
                                                <td><?php if($request['faccepted'] == 1){echo "Accepted";}else if($request['faccepted'] == 0){echo "Pending";}else if($request['faccepted'] == -1){echo "Rejected";}else if($request['faccepted'] == -2){echo "Revoked";}; ?></td>
                                            </tr>
                                    <?php } ?>
                                </tbody>
...
<br>
    ...
    <div class="exp-cont w3-white">
        ...
        <h3>Sent Recommendation Offers</h3>
            <div class="w3-responsive">
                <table class="w3-table w3-bordered w3-striped table_id">
                    <thead>
                    <tr>
                    ...
                    <tbody>
                   <?php foreach($sent_recommendation_offers as $request){?>
                        <tr>
                            <td><a href=""><?php echo $request['freceiver_name']; ?></a></td>
                            <td><a href=""><?php echo $request['freceiver_job_title']; ?></i></a></td>
                            <td><a href=""><?php echo date('M j, Y', strtotime($request['created_at'])); ?></i></a></td>
...
$('#recommendation_offer_submit').click(function() {
checked = $("#gen_impression:checked").length;

    if(checked < 1) {
        alert("You must rate this person on General Impression.");
        return false;
    }
