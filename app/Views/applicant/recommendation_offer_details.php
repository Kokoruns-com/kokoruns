...
<div  class="experience-post-container">
    ...
    <div id="" class="">
        ...
        <h3>This Person Asked To Recommend You</h3>
                ...
                <br>
                 ...
                 <div class="row">
                    <div class="col s12">
                    <p for=""> <strong> Name:</strong> <?php echo $recommendation_offer['fsender_name']; ?></p>
                    <p for=""> <strong> Claimed Relationship With You:</strong> <?php echo $recommendation_offer['frelationship']; ?></p>
                     <p> <strong>Claimed Position At The Time Of Relationship: </strong> <?php echo $recommendation_offer['frelationship-position']; ?></p>
                ...
                <?php if($recommendation_offer['faccepted'] == 0){ ?>
                        <div class="row">
                        
                            <div class="col-sm-6 text-center">
                                <form action="<?php echo site_url('applicant/RecommendationOfferAcceptAction/'. $recommendation_offer['frecno']); ?>" method="post">
                                        <button type="submit" class="btn btn-success">ACCEPT</a>
                                </form>
                            </div>
                            <form action="<?php echo site_url('/applicant/recommendationofferreject/'. $recommendation_offer['frecno']); ?>" method="post">
                ...
                <?php }else if($recommendation_offer['faccepted'] == 1){ ?>
                    <div class="row">
                        
                        <div class="col-sm-12 text-center">
                            <form action="<?php echo site_url('applicant/recommendationacceptancerevoke/'. $recommendation_offer['frecno']); ?>" method="post">
                                <button type="submit" class="btn btn-danger" onclick="return confirm('Are you sure you want to revoke your acceptance?')">REVOKE ACCEPTANCE</button>
                            </form>
                        </div>
                ...
                <?php }else if($recommendation_offer['faccepted'] == -1){ ?>
                    <div class="col-sm-12 text-center">
                            <a class="btn btn-secondary">REJECTED</a>
                        </div>
                    <?php } ?>
                </div>
