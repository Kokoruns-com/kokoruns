                ...
                <div class="col">
                    <div class="dropdown dropleft float-right">
                        ...
                        <a class="dropdown-item" href="<?php echo site_url();?>applicant/experiences">Experiences</a>
                            ...
                            <h1 class="skills-header">Event Details </h1>      
                            ...
                            <h2>Event Details</h2>
                                ...
                                <div class="experience_box"> 
                                       ...
                                       <p> <strong> Event title:</strong> <?php echo $event_details['ftitle'];?></p>
                                       <p> <strong>From:</strong> <?php echo date('F j, Y | H:i a', strtotime($event_details['ffrom']));?></p>
                                       <p> <strong>To: </strong> <?php echo date('F j, Y | H:i a', strtotime($event_details['fto']));?></p>
                                       <p> <strong>Description: </strong><?php echo $event_details['fdescription'];?></p>
                                       <p> <strong>Convener:</strong> <?php echo $event_details['fauthor'];?></p>
                                       <p> <strong>Invitees: </strong><?php echo $event_details['finvitees'];?></p>
