				...
				$output .= '
					<div class="row border rounded m-2">
						<div class="col-lg-7 p-0">
							<div class="text-white p-3 rounded-left background_image">
								<h5>'.strtoupper($event['ftitle']).'</h5>
								<i class="fa fa-calendar text-white"></i> &nbsp;'.date('M j, Y', strtotime($event['ffrom'])).' - '.date('M j, Y', strtotime($event['fto'])).' | <i class="fa fa-map-marker"></i> &nbsp;'.$event['fevent_location'].'
					...
					<div class="col-lg-5">
						<div class="row mt-5">
							<div class="col-lg-4">
								<img src="https://images.pexels.com/photos/587741/pexels-photo-587741.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="" width="100%" data-toggle="modal" data-target="#myModalx">
							</div>
							<div class="col-lg-4">
								<img src="https://images.pexels.com/photos/587741/pexels-photo-587741.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="" width="100%">
							</div>
							<div class="col-lg-4">
								<img src="https://images.pexels.com/photos/587741/pexels-photo-587741.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="" width="100%">
							</div>
